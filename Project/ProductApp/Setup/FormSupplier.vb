...
Public Class FormSupplier
    ...
    Private Sub FormSupplier_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub ToolStripButtonNew_Click(sender As System.Object, e As System.EventArgs) Handles ToolStripButton2.Click
        Me.PanelMain.Controls.Clear()
    ...
    Private Sub ToolStripButtonData_Click(sender As System.Object, e As System.EventArgs) Handles ToolStripButton1.Click
        Me.PanelMain.Controls.Clear()
        uc = viewData
        viewData.loadData()
        uc.Dock = DockStyle.Fill
