...
Public Class UserControlOrderInput
    ...
    Public Property viewData As UserControlOrderData

    Public Sub New(ByVal uc As UserControlOrderData)
    ...
    Private Sub ButtonSearchSupplier_Click(sender As System.Object, e As System.EventArgs) Handles ButtonSearchSupplier.Click
        ...
        If TextBoxSupplier.Text <> "" And IsNumeric(TextBoxSupplier.Text) Then
            SetSupplierValue()
        End If
    ...
    Private Sub SetSupplierValue()
        svrSup = New Service.SupplierService()
        If IsNumeric(TextBoxSupplier.Text) Then
        ...
        If validateFormItem() = True Then
            ...
            Else
                If idx <> -1 And (NumericUpDownQtt.Value = CInt(dgvProdTransact.Rows(idx).Cells("qty_stock").Value)) Then
                    MessageBox.Show("No changes to save", "Alert", MessageBoxButtons.OK, MessageBoxIcon.Error)
                Else
